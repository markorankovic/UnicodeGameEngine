...
public class Node { 
	...
	// The double variables above this comment are needed for the Action class.
	ArrayList<Action> onGoingActions = new ArrayList<Action>();
	ArrayList<Action> actionsToAdd = new ArrayList<Action>();
	ArrayList<Action> actionsToRemove = new ArrayList<Action>();
	/* The ArrayLists above this comment are used by the GameScene for determining 
	...
	int zPosition = 0;
	// These five last variables are only related to the Node itself.
	PhysicsBody physicsbody = null; // PhysicsBody for the node.
